...
Java_de_iteratec_loomo_ros_nodes_AmclNode_execute(
        JNIEnv *env,
...
Java_com_example_ros_1ndkt_1test_RosJniService_stringFromJNIROS(
        JNIEnv *env,
        jobject /* this */) {
    std::string hello = "Hello from ROS";
  return env->NewStringUTF(hello.c_str());
}

extern "C"
JNIEXPORT jint JNICALL 
Java_de_iteratec_loomo_ros_nodes_AmclNode_shutdown
        (JNIEnv *, jobject) {
